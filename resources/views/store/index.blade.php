...
<div style="max-width: 1280px; margin: 0 auto; padding: 64px 16px;">
        ...
        <div style="position: relative; background: white; border-radius: 8px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); display: flex; flex-direction: column;">
            ...
            <div style="padding: 16px; flex: 1; display: flex; flex-direction: column;">
                <div style="margin-bottom: 8px; flex: 1;">
                    ...
                    {{-- Nom de catégorie masqué
                    <p style="margin-top: 4px; font-size: 12px; color: #6b7280; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $product->category->name }}</p>
                    --}}
                    {{-- Description masquée pour le moment
                    <p style="margin-top: 8px; font-size: 12px; color: #6b7280; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; line-height: 1.5; max-height: 4.5em;">{{ Str::limit($product->description, 100) }}</p>
                    --}}
                </div>
    ...
    <div style="text-align: center; padding: 64px 16px;">
        ...
        <h3 style="margin-top: 16px; font-size: 18px; font-weight: 500; color: #111827;">Aucun produit disponible</h3>
